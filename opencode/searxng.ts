...
export default tool({
  description: `Free, unlimited keyword-based metasearch. Fallback when web_search rate-limited, returns empty, or errors. Returns ~150 char snippets.

Prefer web_search for deep technical research, semantic queries, or code-heavy results — ~500+ char highlights, better token efficiency. Use searxng for keyword-based exploration, site-specific searches (site:github.com), community opinions, and package/library discovery.

Engine combos:
  {q:"site:github.com <topic>"}                                 // GitHub repo discovery
  {q:"<topic>", engines:"google,duckduckgo,brave"}              // broad exploration
  {q:"<topic>", engines:"hackernews,reddit"}                    // community opinions
  {q:"<topic>", engines:"google,stackoverflow,github"}          // technical debugging
  {q:"<topic>", engines:"google,arxiv,google_scholar"}          // academic research
  {q:"<language> <need> library", categories:"it,packages"}     // library/package discovery

Limitations: keyword-only (no semantic search), short snippets, no result deduplication. Brave engine may hit rate limits — retry without it.`,
  args: {
